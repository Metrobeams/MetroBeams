defmodule PlataformaWeb.LayoutsTest do
  ...
  test "dropdown shows status icon for each notification" do
    ...
    html =
      render_component(&Layouts.app_header/1,
        notification_summary: %{unread_count: 1, notifications: [notification]},
  ...
  test "dropdown shows close button for all notifications regardless of read status" do
    ...
    html =
      render_component(&Layouts.app_header/1,
        notification_summary: %{unread_count: 1, notifications: [unread, read]},
        current_scope: @current_scope,
        current_path: "/"
      )
